      ...
      <div className="w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            // disabled={true}
            className="h-10 px-5 bg-gradient-to-r from-[#66859E] to-[#849EB2] text-white disabled:opacity-50 font-medium hover:opacity-90 rounded-[12px] text-sm transition-all shadow-sm font-sans flex items-center gap-2 "
          >
